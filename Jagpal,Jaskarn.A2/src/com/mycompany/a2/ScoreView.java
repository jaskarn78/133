...
public class ScoreView extends Container implements Observer{
	...
	public void update(Observable observable, Object data) {
		...
		//totalPts.setText("Total Points: "+gw.getTotalScore());
		//dogsCaught.setText("Dogs caught: "+gw.getDogsC());
		//catsCaught.setText("Cats Caught: "+gw.getCatsC());
		//InitDog.setText("Remaining Dogs: "+gw.getDogsR());
		//InitCat.setText("Remaining Cats: "+gw.getCatsR());
